        ...
        <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                helperText={firstNameError.errorBoolean && firstNameError.name}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                helperText={lastNameError.errorBoolean && lastNameError.name}
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
            ...
            <Grid item xs={12}>
              <TextField
                ...
                helperText={
                  passwordConfirmError.errorBoolean && passwordConfirmError.name
                }
              />
            </Grid>
          </Grid>
          ...
          <Grid container justifyContent="center">
            <Grid item>
              ...
              <Link href="/sign-in" variant="body2" sx={{ ml: 1 }}>
                Sign in
              </Link>
            </Grid>
          </Grid>
